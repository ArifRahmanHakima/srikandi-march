<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="flex h-full items-center">
    <main class="w-full max-w-md mx-auto p-6">
      <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-white-800 dark:border-gray-300">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-600 dark:text-grey">Ubah Kata Sandi</h1>
          </div>
          ...
          <div class="mt-5">
            ...
            <form>
              <div class="grid gap-y-4">
                <!-- Form Group -->
                <div>
                  <label for="password" class="block text-sm mb-2 dark:text-grey">Kata Sandi</label>
                  <div class="relative">
                ...
                <div>
                  <label for="password_confirmation" class="block text-sm mb-2 dark:text-grey">Konfirmasi Kata Sandi</label>
                  <div class="relative">
                  ...
                  <p class="text-xs text-red-600 mt-2" id="password_confirmation-error">Konfirmasi Kata Sandi Salah</p>
                </div>
