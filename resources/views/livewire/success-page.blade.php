  ...
  <div class="justify-center flex-1 max-w-6xl sm:px-6 lg:px-8 mx-auto px-4 py-4 mx-auto bg-white border rounded-md dark:border-gray-300 white:bg-gray-900 md:py-10 md:px-10">
    <div>
      ...
      <div class="flex items-center justify-start gap-4 px-4 mt-6>">
        ...
        <a href="/data-payment/{{ $order->id }}" class="w-full text-center px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-auto dark:text-gray-300 hover:bg-blue-600 dark:hover:bg-gray-700 dark:bg-gray-800">
          Bayar Sekarang
        </a>
      </div>
    </div>
