<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <h1 class="text-4xl font-bold text-slate-700">History Pesanan</h1>
              ...
              @forelse ($orders as $order)
                ...
                <tr class="odd:bg-white even:bg-gray-100 white:odd:bg-slate-900" wire:key="{{ $order->id }}">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                    ...
                    <a href="/review/{{ $order->id }}" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md">Beri Ulasan</a>
                  </td>
                </tr>
              @empty
                <tr>
