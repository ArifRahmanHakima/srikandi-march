  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      ...
      <div class="relative ms-4 overflow-hidden" id="autoSlider">
        ...
        <div class="flex w-full transition-transform duration-1000 ease-in-out">
          <!-- Gambar 1 slider -->
          <div class="min-w-full relative">
            <img class="w-full rounded-md" src="https://dynamic.zacdn.com/ZjczyATKvyE9b64_6eBpKxj1CzE=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/batik-mayung-0607-4020593-1.jpg" alt="Batik Mayung">
          ...
          <!-- Gambar 2 slider -->
          <div class="min-w-full relative">
            <img class="w-full rounded-md" src="https://dynamic.zacdn.com/vNDNWOVGVFYMmBwbnmbQCdZJTck=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/batik-mayung-1786-0766724-1.jpg" alt="Batik Modern">
            <div class="absolute inset-0 -z-[1] bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 w-full h-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6 dark:from-slate-800 dark:via-slate-900/0 dark:to-slate-900/0"></div>
            </div>
            ...
            <!-- Gambar 3 slider -->
          <div class="min-w-full relative">
            <img class="w-full rounded-md" src="https://dynamic.zacdn.com/3ugu3IPpxjyKJhW7LoqcorNiMf8=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/batik-mayung-3823-8603014-1.jpg" alt="Batik Modern">
            <div class="absolute inset-0 -z-[1] bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 w-full h-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6 dark:from-slate-800 dark:via-slate-900/0 dark:to-slate-900/0"></div>
          </div>

          <!-- Gambar 4 slider -->
          <div class="min-w-full relative">
            <img class="w-full rounded-md" src="https://dynamic.zacdn.com/uwjkHvo38RAnjLLmp_zkBDH_RIc=/filters:quality(70):format(webp)/https://static-id.zacdn.com/p/batik-mayung-2010-0925014-1.jpg" alt="Batik Modern">
            <div class="absolute inset-0 -z-[1] bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 w-full h-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6 dark:from-slate-800 dark:via-slate-900/0 dark:to-slate-900/0"></div>
            </div>
...
<div class="bg-orange-200 py-20">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold dark:text-gray-200"> Batik <span class="text-blue-500"> Kategori
          </span> </h1>
        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
          <div class="flex-1 h-2 bg-blue-200">
          </div>
